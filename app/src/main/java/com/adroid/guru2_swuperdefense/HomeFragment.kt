...
/**
 * 홈 화면. 마지막 피해 진단 기반 보안점수, 피해상황확인 진입점, 미니카드 4개, 최근 활동 3건을 보여준다.
 * 최근 활동 카드는 [ActivityLogListFragment]와 모양·클릭 동작을 공유하기 위해 [ActivityLog]를 통해 그린다.
 */
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(
        ...
        // cardChecklist는 후속 조치 안내 화면(FollowUpFragment)으로 이동한다.
